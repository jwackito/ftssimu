...
import datetime
#bandwidth = (5*10**9)/8.
#bandwidth = (5*10**9)/8./5
#bandwidth = (170.2*10**6) # perfect fit zone 1
bandwidth = (15*10**6)
#bandwidth = (300*10**6) # way too much speed
max_active = 37 
current_active = 0
current_queued = 0
...
while current_time < xfers.loc[20000-1].submited or current_active > 0:
    ...
    for xfer in active_transfers:
        active_transfers[xfer]['remaining'] -= bandwidth/(max(current_active,1))
